// ======================================================================
// \title Atmel/Os/RawTime.hpp
// \brief Atmel definitions for Os::RawTime
// ======================================================================
...
struct AtmelRawTimeHandle : public RawTimeHandle {
    U32 m_seconds;
    U32 m_micros;
};
...
//!
class AtmelRawTime : public RawTimeInterface {
  public:
    //! \brief constructor
    //!
    AtmelRawTime() = default;

    //! \brief destructor
    //!
    ~AtmelRawTime() override = default;
