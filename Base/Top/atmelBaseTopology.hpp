// ======================================================================
// \title  atemlBaseTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef ATEMLBASE_ATEMLBASETOPOLOGY_HPP
#define ATEMLBASE_ATEMLBASETOPOLOGY_HPP
// Included for access to atemlBase::TopologyState and atemlBase::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <atemlBase/Top/atemlBaseTopologyDefs.hpp>

// Remove unnecessary atemlBase:: qualifications
using namespace atemlBase;
namespace atemlBase {
/**
 ...
 * atemlBase::TopologyState see: atemlBaseTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type atemlBase::TopologyState see: atemlBaseTopologyDefs.hpp.
 *
